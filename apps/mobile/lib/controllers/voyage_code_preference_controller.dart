...
class VoyageCodePreferenceController extends ChangeNotifier {
  VoyageCodePreferenceController._(
    this._preferences,
    this._keepCode,
    String? savedCode,
  ) : _savedCode = _validCode(savedCode);

  static const keepCodeKey = 'join_keep_last_voyage_code';
  static const savedCodeKey = 'join_last_voyage_code';
  ...
  static Future<VoyageCodePreferenceController> load() async {
    ...
    return VoyageCodePreferenceController._(preferences, keepCode, savedCode);
  }

  @visibleForTesting
  factory VoyageCodePreferenceController.memory({
    bool keepCode = true,
    String? savedCode,
  }) => VoyageCodePreferenceController._(null, keepCode, savedCode);
  ...
  /// The current form value remains untouched so the sailor can correct it.
