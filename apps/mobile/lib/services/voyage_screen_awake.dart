...
/// Keeps the display awake while the active-voyage shell exists.
///
...
class VoyageScreenAwakeCoordinator with WidgetsBindingObserver {
  VoyageScreenAwakeCoordinator({
