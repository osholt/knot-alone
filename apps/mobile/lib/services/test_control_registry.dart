...
/// Where the active voyage publishes its situational-awareness controller so the
/// test-control surface can reach it.
///
/// The surface is started once at launch, but
/// [SituationalAwarenessController] is created per voyage inside `ActiveVoyageShell`
...
/// controller is the ordinary state - no voyage is active - and the surface answers
