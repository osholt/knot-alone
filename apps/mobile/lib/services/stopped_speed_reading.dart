...
/// zeroes (#210). But losing signal is also silence, and a sailor in a tunnel at
/// 60 mph produces exactly the same nothing as a sailor at a red light.
///
...
/// ## What breaks the tie
///
/// The last speed actually observed. A sailor who was already down to walking
/// pace and then went quiet has almost certainly stopped — that is what stopping
/// looks like through a `distanceFilter`. A sailor who was doing 60 and went quiet
...
///
/// About 7 mph. Chosen low on purpose: the cost of reading zero when the sailor is
/// actually moving is far higher than the cost of reading blank for another
/// second while they roll to a halt. A sailor decelerating passes through this
...
/// What to show, given how the sailor was last seen moving.
///
