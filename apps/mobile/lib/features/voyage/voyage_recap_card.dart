...
/// A shareable social-media summary card for a completed voyage: route shape,
/// sailor count, distance, voyage time, and marker passes.
class VoyageRecapCard extends StatelessWidget {
  const VoyageRecapCard({
    super.key,
  ...
  /// the sailor frames is the map captured into the PNG (#157).
  ...
  /// touches the app theme, the voyage map, or anything stored.
  final bool dark;
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        if (routePoints.length < 2)
                          // #124: a voyage with no route is valid, and its recap
                          // says so rather than failing.
                          Center(
                            child: Text(
                              'No recorded route for this voyage',
                              style: TextStyle(
                          ...
                          // the line stay put while the sailor panned the map.
                          Padding(
              ...
              Row(
                children: [
                  _Stat(
                    ...
                    label: 'Voyage time',
                    value: _duration(summary.voyageDuration),
                  ),
                  _Stat(
...
class _Stat extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Expanded(
    child: Row(
      children: [
        Icon(icon, color: VoyageRecapCard._accent, size: 22),
