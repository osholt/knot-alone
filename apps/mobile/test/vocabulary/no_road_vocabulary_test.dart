...
void main() {
  ...
  const allowed = <String, String>{
    ...
    'lib/domain/imported_route.dart':
        'matches the description string older builds wrote into GPX; the '
        'exporter already writes "Passage generated by Tide and Seek"',
    'lib/services/gpx_exporter.dart':
        'GPX extension keys that must round-trip with files already exported',
