...
/// The live voyage map used to have no basemap failure handling at all, while the
...
void main() {
  ...
  testWidgets('tapping the badge explains the fault in words', (tester) async {
    ...
    expect(
      ...
      findsOneWidget,
      reason: 'a sailor needs something they can repeat back to us',
    );
  ...
  testWidgets('a build with no style configured keeps its route-only badge', (
    ...
    // and the wording sailors already know is the wording they keep.
    await pumpMap(
      tester,
