...
void main() {
  ...
  test('remembers and replaces only valid successful voyage codes', () async {
    final controller = await VoyageCodePreferenceController.load();
    ...
    expect(
      preferences.getString(VoyageCodePreferenceController.savedCodeKey),
      '654321',
    );
  });
  ...
  test('opt out clears the value and prevents future saves', () async {
    ...
    final preferences = await SharedPreferences.getInstance();
    expect(
      preferences.containsKey(VoyageCodePreferenceController.savedCodeKey),
      isFalse,
    );
  });
  ...
  test('load discards malformed preference values', () async {
    SharedPreferences.setMockInitialValues({
      VoyageCodePreferenceController.savedCodeKey: '123456#secret',
    });
